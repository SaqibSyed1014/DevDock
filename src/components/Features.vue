<template>
  <section class="container mx-auto">
    ...
    <div class="bg-[#EBFAFE] rounded-[10px] text-center pt-28 pb-14 mb-14">
    ...
    <div class="bg-[#FFE8BC] rounded-[10px] text-center pt-28 pb-14 mb-14">
      <div class="w-3/4 mx-auto">
        <h4 class="text-primary text-4xl font-medium pb-6">
    ...
    <div class="bg-[#BCDFFF] rounded-[10px] text-center pt-28 pb-14 mb-14">
      <div class="w-3/4 mx-auto">
        <h4 class="text-primary text-4xl font-medium pb-6">
    ...
    <div class="bg-primary rounded-[10px] text-center pt-28 pb-14 mb-14">
